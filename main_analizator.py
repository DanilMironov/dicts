...
from binary_search_dict import BinaryArray
...
class MainAnalizator:
    ...
    def main():
        ...
        for i in range(len(test_list)):
            ...
            analizator.analyze()
        binary_dict = BinaryArray
        for i in range(len(test_list)):
            bin_analizator = Analizator(binary_dict, data,
                                        'BinaryArrayDict', test_list[i])
            bin_analizator.analyze()
        tree_dict = TreeDict
        for i in range(len(test_list)):
